...
import { BinarySmlDecoder, BinarySmlEncoder, SmlAttribute, SmlDocument, SmlElement, SmlEmptyNode, SmlNode, SmlParser, SmlParserError, SyncWsvDocumentLineIterator, SyncWsvJaggedArrayLineIterator, Uint8ArrayReader } from "../src/sml.js";
...
describe("SmlParser Async", () => {
    test("Given", async () => {
        ...
        const node1 = await SmlParser.readNode(iterator, rootElement);
        expect(node1.toString()).toEqual("Attribute1 10");
        const node2 = await SmlParser.readNode(iterator, rootElement);
        expect(node2.toString()).toEqual("Sub\nSubAttr -\nEnd");
        const node3 = await SmlParser.readNode(iterator, rootElement);
...
describe("BinarySmlEncoder.encodeElement", () => {
    ...
    ])("Given %p and %p returns %j", (input1, input2, output) => {
...
describe("BinarySmlDecoder.internalDecodeNode", () => {
    test("internalDecodeNode", () => {
        ...
        expect(result === null || result === void 0 ? void 0 : result.toString()).toEqual(`A -`);
    });
    test.each([
